export default {
  ...
  _widgetDescription: "A widget for creating elevation profiles from single- or multi-segment lines on a web map or scene.",
  mapLoadingMsg: 'Please wait while the map is loading',
  _action_select_label: 'View profile',
  ...
  infoMsgWhileSelecting: 'Select a connected line or click Done to finish.',
  ...
  elevationQueryError: 'There was an error retrieving elevation data for the profile.',
  ...
  referenceLayerLabel: '{elevationLayerLabel} (Reference)',
